...
async function queryLibrary(payload, ctx) {
  ...
  if (!embedder)
    throw new Error(`[query_chunks_component] Error loading vectorstore with embedder_model = ${embedder_model}, hasher_model = ${hasher_model}, Library = ${vectorstore_name}`);
